...
class QuantumGraphBuilder(ABC):
    ...
    def _construct_components(
        ...
        # TODO: we either need to custom QG builders to call
        # skeleton.attach_dimension_records() or extract dimension records
        # from skeleton data IDs here.
    ...
    def _make_predicted_datasets(
        ...
        connection_names_by_dataset_type = {
            edge.parent_dataset_type_name: edge.connection_name for edge in edges
        }
        result: dict[str, list[PredictedDatasetModel]] = {}
        for dataset_key in dataset_keys:
            connection_name = connection_names_by_dataset_type.get(dataset_key.parent_dataset_type_name)
            ...
            result.setdefault(connection_name, []).append(PredictedDatasetModel.from_dataset_ref(ref))
        return result
