...
class TaskMappingView(MappingView[TaskNode]):
    ...
    def between(self, first: str | None = None, last: str | None = None) -> Mapping[str, TaskNode]:
        ...
        between : `~collections.abc.Mapping` [ `str`, `TaskNode` ]
            ...
            both bounding tasks.
        """
        # This is definitely not the fastest way to compute this
        # subset, but it's a very simple one (given what networkx
        # provides, and pipeline graphs are never *that* big.
