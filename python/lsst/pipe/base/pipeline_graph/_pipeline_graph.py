...
class PipelineGraph:
    ...
    def diff_tasks(self, other: PipelineGraph) -> list[str]:
        ...
        if self.tasks.keys() != other.tasks.keys():
            ...
            messages.append(
                f"Pipelines have different tasks: {self.tasks.keys() - common_labels} are only in self, "
                f"while {other.tasks.keys() - common_labels} are only in other."
            )
        else:
        ...
        for label in common_labels:
            ...
            if a.task_class != b.task_class:
                messages.append(
                    f"Task {label!r} has class {a.task_class_name} in self, "
                    f"but {b.task_class_name} in other."
                )
