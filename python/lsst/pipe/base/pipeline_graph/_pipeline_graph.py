...
class PipelineGraph:
    ...
    def select(self, expression: str) -> PipelineGraph:
        ...
        new_pipeline_graph.add_task_nodes(
            [self._xgraph.nodes[key]["instance"] for key in matching_task_keys], parent=self
        )
    ...
    def _select_expression(self, node: expressions.Node, task_xgraph: networkx.DiGraph) -> set[NodeKey]:
        ...
        node : `expressions.Node`
            Expression node to process (recursively).
