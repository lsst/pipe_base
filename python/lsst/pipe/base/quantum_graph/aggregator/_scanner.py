...
from ...log_capture import _ProvenanceLogRecordsExtra
...
class Scanner:
    ...
    def _read_log(self, predicted_quantum: PredictedQuantumDatasetsModel, result: ScanResult) -> uuid.UUID:
        ...
        try:
            ...
            if log_records.extra:
                log_extra = _ProvenanceLogRecordsExtra.model_validate(log_records.extra)
