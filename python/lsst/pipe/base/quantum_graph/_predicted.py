    ...
    def write(
        ...
        *,
        ...
        with BaseQuantumGraphWriter.open(
            ...
            writer._write_single_model("thin_graph", self.thin_graph)
            ...
            writer._write_single_model("dimension_data", serialized_dimension_data)
            del serialized_dimension_data
            writer._write_single_model("init_quanta", self.init_quanta)
            with MultiblockWriter.open_in_zip(
                writer.zf, "quantum_datasets", self.header.int_size
