...
class Task(object):
    ...
    * If "run" can persist data then the task's config should offer a flag to disable persistence.
    ...
    def getSchemaCatalogs(self):
        """Return a dict of empty catalog objects that can be used to save all the schemas
        of all catalogs generated by this task.  Dict keys should be the butler dataset
        of the catalog, and values should be the correct lsst.afw.table catalog class.

        Subtasks should be called recursively, and their schemas added to the returned dict.
