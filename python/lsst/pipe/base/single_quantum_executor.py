...
class SingleQuantumExecutor(QuantumExecutor):
    ...
    def __init__(
        ...
        *,
        ...
        self._enableLsstDebug = enable_lsst_debug
    ...
    def _execute(
        ...
        with log_capture.capture_logging(task_node, quantum) as captureLog:
            ...
            if self.check_existing_outputs(quantum, task_node, limited_butler):
                _LOG.info(
            ...
            try:
                quantum = self.updated_quantum_inputs(quantum, task_node, limited_butler)
                ...
                self.write_metadata(quantum, fullMetadata, task_node, limited_butler)
                return quantum

            # enable lsstDebug debugging
            if self._enableLsstDebug:
                try:
            ...
            try:
                caveats, outputsPut, butler_metrics = self.run_quantum(
    ...
    def init_globals(self, quantum: Quantum) -> None:
