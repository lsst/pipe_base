...
class QuantaAdjuster:
    ...
    def get_prerequisite_inputs(
        ...
        inputs : `dict` [ `str`, \
            ...
            Data IDs of prerequisite inputs, keyed by the connection name (the
            internal task name, not the dataset type name).  This only contains
            prerequisite inputs, not init-inputs or regular inputs.
