...
class _ProvenanceLogRecordsExtra(pydantic.BaseModel):
    ...
    previous_attempts: list[_ProvenanceLogRecordsExtra] = pydantic.Field(default_factory=list)
...
class _LogCaptureContext:
    ...
    extra: _ProvenanceLogRecordsExtra = dataclasses.field(default_factory=_ProvenanceLogRecordsExtra)
