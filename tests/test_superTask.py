...
from SuperTask instead of Task. It does not have yet testing of new
SuperTask-specific methods.
"""
#
...
class MultTask(supertask.SuperTask):
...
class AddMultTask(supertask.SuperTask):
    ...
    def __init__(self, **keyArgs):
        super(AddMultTask, self).__init__(**keyArgs)
